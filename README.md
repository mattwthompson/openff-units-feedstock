...
pixi add openff-units
# for installing globally
pixi global install openff-units
```
...
It is possible to list all of the versions of `openff-units` available on your platform:
...
```
pixi search openff-units --channel conda-forge
```
